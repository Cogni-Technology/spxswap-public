...
const sporeLight = {
  ...
  neutral1: '#131313',
  neutral1Hovered: 'rgba(19, 19, 19, 0.88)',
  neutral2: 'rgba(19, 19, 19, 0.78)',
  neutral2Hovered: 'rgba(19, 19, 19, 0.88)',
  neutral3: 'rgba(19, 19, 19, 0.55)',
  neutral3Hovered: 'rgba(19, 19, 19, 0.7)',
  ...
  accent1: '#B8890A',
  accent1Hovered: '#966E08',
  accent2: 'rgba(184, 137, 10, 0.08)',
  accent2Hovered: 'rgba(184, 137, 10, 0.12)',
  accent2Solid: '#FDF6E0',
  accent3: '#222222',
  accent3Hovered: colors.black,

  DEP_accentSoft: '#D4A01733', //33 = 20%
  DEP_blue400: '#B8890A',
...
const sporeDark = {
  ...
  surface1: '#0C0C0E',
  surface1Hovered: '#121214',
  surface2: '#121214',
  surface2Hovered: '#18181B',
  surface3: 'rgba(212, 160, 23, 0.10)',
  surface3Solid: '#18181B',
  surface3Hovered: 'rgba(212, 160, 23, 0.14)',
  surface4: 'rgba(212, 160, 23, 0.18)',
  surface5: 'rgba(0,0,0,0.04)',
  surface5Hovered: 'rgba(0,0,0,0.06)',
  accent1: '#D4A017',
  accent1Hovered: '#E8B930',

  accent2: 'rgba(212, 160, 23, 0.08)',
  accent2Hovered: 'rgba(212, 160, 23, 0.14)',
  accent2Solid: '#241B06',
...
export const colorsLight = {
  ...
  DEP_backgroundBranded: '#FDF6E0',
  DEP_backgroundOverlay: opacifyRaw(60, colors.white),

  DEP_accentBranded: '#B8890A',
  DEP_shadowBranded: '#B8890A',

  DEP_brandedAccentSoft: '#FDF6E0',
  DEP_magentaDark: opacifyRaw(12, '#B8890A'),
...
export const colorsDark = {
  ...
  DEP_backgroundBranded: '#0C0C0E',
  DEP_backgroundOverlay: opacifyRaw(10, colors.white),

  DEP_accentBranded: '#D4A017',
  DEP_shadowBranded: '#D4A017',

  DEP_brandedAccentSoft: '#2A2106',
  DEP_magentaDark: opacifyRaw(12, '#D4A017'),
