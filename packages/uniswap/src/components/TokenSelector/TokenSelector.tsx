...
// oxlint-disable-next-line eslint/no-unused-vars -- zIndexes used by the v1-hidden TokenSelectorNetworkFilter below
...
// oxlint-disable-next-line eslint/no-unused-vars -- isExtensionApp used by the v1-hidden TokenSelectorNetworkFilter below
...
// SPXSwap v1 is mainnet-only and hides the network filter inline in the token
// selector search bar. Keep this component + all its wiring intact so a future
// multichain expansion can re-render it via the endAdornment below.
// oxlint-disable-next-line eslint/no-unused-vars -- preserved for future multichain support
...
export function TokenSelectorContent({
  ...
  isSurfaceReady = true,
  onClose,
  // oxlint-disable-next-line eslint/no-unused-vars -- onSelectChain unused while TokenSelectorNetworkFilter is hidden for v1
  onSelectChain,
  onSelectCurrency,
  renderedInModal,
  ...
  // oxlint-disable-next-line eslint/no-unused-vars -- onChangeChainFilter unused while TokenSelectorNetworkFilter is hidden for v1
  ...
  // oxlint-disable-next-line eslint/no-unused-vars -- tieredNetworkOptions feeds the v1-hidden TokenSelectorNetworkFilter
      ...
      <Trace logImpression element={currencyFieldName} section={SectionName.TokenSelector}>
        <Flex grow gap="$spacing8" style={scrollbarStyles}>
          ...
          <SearchTextInput
            ...
            endAdornment={
              // SPXSwap v1 is mainnet-only, so the inline network filter is
              // hidden (not deleted — keep TokenSelectorNetworkFilter + the
              // useNetworkSelectorOptions plumbing above intact so a future
              // multichain expansion can re-enable it trivially).
              hasClipboardString ? (
